...
function QuizPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-gray-600 dark:text-gray-300">Quiz</h2>
      ...
      <form onSubmit={handleSubmit} className="mt-4">
        <input
          ...
          className="w-full p-2 border dark:border-gray-600 rounded-lg text-gray-600 dark:text-gray-300 dark:bg-gray-700"
